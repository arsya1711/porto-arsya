...
test("durasi ujian wajib berupa menit bulat positif tanpa batas maksimum jadwal", () => {
  ...
  assert.equal(isValidExamDuration(481), true);
  assert.equal(isValidExamDuration(7 * 24 * 60), true);
});
