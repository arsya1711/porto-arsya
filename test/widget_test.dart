...
void main() {
  ...
  testWidgets('student history hides direct exam scores', (tester) async {
    await tester.pumpWidget(const AWExamApp());
    await tester.pumpAndSettle();
    ...
    expect(find.text('Riwayat pengerjaanmu'), findsOneWidget);
    expect(find.text('Sudah dikumpulkan'), findsOneWidget);
    expect(find.text('Nilai'), findsNothing);
